            ...
            <div>
                  ...
                  { isMobile ? (
                    <Accordion>
                      <AccordionSummary
                        ...
                        id="panel1a-header"
                      >
                        <Typography sx={{ fontSize: '17px', fontFamily: '"Lato", sans-serif', textAlign: 'center', color: '#00011b' }} variant='body2'>
                        Lisätietoa tuloksista
                        </Typography>
                      </AccordionSummary>
                      <AccordionDetails>
                        <Typography sx={{ fontSize: isMobile ? '17px' : '18px', fontFamily: '"Lato", sans-serif', textAlign: 'center', color: '#00011b' }} variant='body2'>
                    ...
                    </Typography><Typography sx={{ fontSize: isMobile ? '17px' : '18px', fontFamily: '"Lato", sans-serif', textAlign: 'center', color: '#00011b', mt: 4, mb: 6, lineHeight: 2 }} variant='body2'>
              ...
              <Grid container direction="row" spacing={10} justifyContent="center">
                <Grid item xs={12} sm={10} md={10} lg={7} >
                  <div>
                    <Typography sx={{ mb: 3, mt: isMobile ? -28 : 5, textAlign: 'center', fontFamily: '"Lato", sans-serif', color: '#00011b' }} variant='h4' className='strengths'>Vahvuudet</Typography>
                    {strengthText}
              ...
              <Grid sx={{ my: 1, mt: isMobile ?  -5 : 3.5 }} container direction="column" spacing={12} justifyContent="center">
                <Grid item xs={12} sm={8} md={6} lg={4} justifyContent="center">
                  {!isMobile
                    ?
                  ...
                  <Typography sx={{ mt: '4px', fontSize: isMobile ? '13px' : '18px', fontFamily: '"Lato", sans-serif', textAlign: 'center', color: '#00011b' }} variant='body2'>
